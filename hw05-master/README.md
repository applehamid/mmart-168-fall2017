...
Having worked at a couple mid-sized tech companies, I am fascinated by the idea of scaling, and scalability. It's a topic frequently on the mind by all, though vastly hard to achieve. In one case, the company went through a restructuring of its entire executive team and laid off 100+ employees, saving only the sales team and the most crucial engineers. In the other, a strict management team and a strapped operations budget stagnated the growth of the company.

Here, Airbnb's first product manager shares what he learned about scalability and shares some important insights. Setting specific goals is particularly important in young companies where folks are working 10+ hours a day. Automation is also something at our disposal that can speed up operational inefficiencies. As the writer shares, there will always be fires to put out, but the work is never done to improve both the product as well as the customer's experience with it.
